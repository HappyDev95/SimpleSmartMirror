(function () {
    ...
    function refreshAccessToken() {
        ...
        try {
            ...
            //Note: we are using a POST request here
            ...
            //    client_id: config.strava.client_id,
            //    client_secret: config.strava.client_secret,
            //    //*********THIS WILL SAVE YOU HEADACHES. THIS CODE IS GENERATED BY STRAVA WHEN YOU CHANGE PERMISSIONS, INSERT IT HERE, ex: code: YOUR_CODE
            //    code: "",
            ...
            xhr.onreadystatechange = function () {
                if (this.readyState === XMLHttpRequest.DONE) {
                    if (this.status === 200) {
                        ...
                        console.log(`URL is --> ${config.stravaTokenRefreshEndpoint}`);
                    }                  
                }
            };
    ...
    function processRefreshTokenResponse(data) {
        ...
        logger.logDebug(`Short lived access token = ${shortLivedAccessToken}`);
        logger.logDebug(`Data refresh token = ${config.strava.strava_refreshToken}`);
    }
